function Navigation({ isOpen }) {
  ...
  return (
    <ul
      className={`${isOpen ? "translate-x-[-100%]" : "translate-x-[-0%]"} fixed left-0 top-0 flex h-full w-3/4 flex-col items-center gap-5 bg-white px-10 py-16 shadow-2xl transition-all duration-150 ease-in-out sm:relative sm:translate-x-0 sm:flex-row sm:px-0 sm:py-0 sm:shadow-none`}
    >
